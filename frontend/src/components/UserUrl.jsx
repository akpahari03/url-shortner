      ...
      <div className="bg-white rounded-2xl shadow-lg mt-8 overflow-hidden">
        ...
        <div className="p-6 bg-gradient-to-r from-blue-50 to-purple-50 border-b border-gray-200">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between space-y-4 lg:space-y-0">
            <div>
              ...
              <p className="text-gray-600">Manage and track your {urls.urls.length} shortened links</p>
            </div>
            ...
            <div key={url._id} className="p-6 hover:bg-gray-50 transition-colors duration-200 group">
              <div className="flex flex-col lg:flex-row lg:items-center space-y-4 lg:space-y-0">
                ...
                <div className="flex items-center space-x-3 lg:ml-4 flex-wrap gap-2">
                  ...
                  {/* Test Link Button */}
                  <button
                    onClick={() => window.open(`${getBaseUrl()}/${url.short_url}`, '_blank')}
        ...
        <div className="p-6 bg-gradient-to-r from-blue-50 to-purple-50 border-t border-gray-200">
          <div className="flex items-center justify-center space-x-4 text-center">
            ...
            <div>
              <h4 className="text-lg font-semibold text-gray-800">Production Ready!</h4>
              <p className="text-gray-600 text-sm">Your URL shortener is now live and working across all environments</p>
            </div>
            <div className="text-sm text-blue-600 font-medium">
              {import.meta.env.VITE_NODE_ENV === 'production' ? 'Production' : 'Development'} Mode ⚡
            </div>
          </div>
        </div>
            ...
            <div className="bg-white rounded-2xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
              <div className="p-6 border-b border-gray-200 bg-gradient-to-r from-blue-50 to-purple-50">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-gray-600 mt-1">{getDisplayUrl()}/{selectedUrl.short_url}</p>
                  </div>
                  <button
              ...
              <div className="p-6">
                ...
                <div className="flex space-x-4">
                  ...
                  <button 
                    onClick={() => handleCopy(selectedUrl.short_url, `analytics-${selectedUrl._id}`)}
